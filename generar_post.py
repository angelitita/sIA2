# --- EJECUTANDO SCRIPT v19.2 (ESTABLE) + CORRECCIONES FINALES ---
import os
import datetime
import json
...
print("--- INICIANDO SCRIPT DE GENERACIÓN DE CONTENIDO v19.2 (Estable) ---")
...
# --- CONTENIDO DE PÁGINAS ESTÁTICAS (POLÍTICA RESTAURADA Y COMPLETAS) ---
...
if __name__ == "__main__":
    ...
    if contenido_final:
        ...
        # Se añaden las llamadas para crear las nuevas páginas
