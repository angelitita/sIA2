...
LISTA_DE_IMAGENES = [
    ...
    "imagen-5.png", "imagen-6.png", "imagen-8.png", "imagen-9.png",
    "imagen-10.png", "imagen-11.png"
]
...
def crear_archivo_post(contenido):
    ...
    full_html = (
        ...
        article_content + 
        HTML_FOOTER.format(privacy_path="../privacy.html")
    )
...
def crear_pagina_privacidad():
    ...
    full_html = (
        HTML_HEADER.format(title="Política de Privacidad - sIA", css_path="static/css/style.css", logo_path="static/img/logo.png", index_path="index.html") +
