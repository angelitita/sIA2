# --- EJECUTANDO SCRIPT v15.1: CORRECCIÓN FINAL DE TÍTULOS ---
import os
import datetime
import json
...
print("--- INICIANDO SCRIPT DE GENERACIÓN DE CONTENIDO v15.1 ---")
...
temas_herramientas = ["una comparativa detallada: Midjourney vs. Stable Diffusion.", "una guía de las 5 mejores IAs para editar video en 2025.", "una reseña a fondo de Notion AI, con pros y contras."]
...
def actualizar_paginas(todos_los_posts):
    ...
    # --- CORREGIDO: Títulos de sección en la página principal ---
